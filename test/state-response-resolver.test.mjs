...
import fixture from '../fixtures/state-response-guidance-rescission-partial.v1.mjs';
...
test('resolves a ranked but fail-closed partial-primary-source projection', () => {
  ...
  assert.equal(result.pathways[0].ranking.priority_score, 11);
...
test('requires an identified operative instrument', () => {
  ...
  invalid.mechanism.observed_implementation.events[0].operative = false;
